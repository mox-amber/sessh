...
export default withTracker(() => {
  ...
  const subscriptions = [
    Meteor.subscribe(Genres.userPublicationName),
    Meteor.subscribe(Instruments.userPublicationName),
    Meteor.subscribe(Musicians.userPublicationName),
    Meteor.subscribe(MusiciansGenres.userPublicationName),
    Meteor.subscribe(MusiciansInstruments.userPublicationName),
  ];

  // Determine if the subscriptions are ready
  const ready = subscriptions.every(subscription => subscription.ready());
